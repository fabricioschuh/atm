...
public class ATM {
    ...
    public void withdraw(BigDecimal moneyToWithdraw) throws NotEnoughMoneyException, NotEnoughCombinationException {
        ...
        //withdraw Bills
        moneyToWithdraw = withdrawBills(moneyToWithdraw, BillType.HUNDRED, "100.00");
        moneyToWithdraw = withdrawBills(moneyToWithdraw, BillType.FIFTY, "50.00");
        moneyToWithdraw = withdrawBills(moneyToWithdraw, BillType.TWENTY, "20.00");
        moneyToWithdraw = withdrawBills(moneyToWithdraw, BillType.TEN, "10.00");
        moneyToWithdraw = withdrawBills(moneyToWithdraw, BillType.FIVE, "5.00");
        moneyToWithdraw = withdrawBills(moneyToWithdraw, BillType.TWO, "2.00");
        moneyToWithdraw = withdrawBills(moneyToWithdraw, BillType.ONE, "1.00");

        //withdraw Coins
        moneyToWithdraw = withdrawCoins(moneyToWithdraw, CoinType.FIFTY, "0.50");
        moneyToWithdraw = withdrawCoins(moneyToWithdraw, CoinType.TWENTYFIVE, "0.25");
        moneyToWithdraw = withdrawCoins(moneyToWithdraw, CoinType.TEN, "0.10");
        moneyToWithdraw = withdrawCoins(moneyToWithdraw, CoinType.FIVE, "0.05");
        moneyToWithdraw = withdrawCoins(moneyToWithdraw, CoinType.ONE, "0.01");
    ...
    private BigDecimal withdrawBills(BigDecimal moneyToWithdraw, BillType billType, String stringValue) {
    ...
    private BigDecimal withdrawCoins(BigDecimal moneyToWithdraw, CoinType coinType, String stringValue) {
        //quantity needed to withdraw
